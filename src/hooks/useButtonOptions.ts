...
export default function useButtonOptions(): {
  ...
  handleExport: () => void;
  copyToClipboard: (css: string) => void;
  randomButton: () => void;
} {
  ...
  const handleExport = () => {
    const file = new Blob([JSON.stringify(options)], {
  ...
  const randomButton = () => {
    const styles = {
      ...
      catUrl: [
        ...
        'https://cataas.com/cat/says/Hello?filter=sepia',
        'https://cataas.com/cat/says/Hello?filter=blur',
        'https://cataas.com/cat/says/Hello?filter=grayscale',
        'https://cataas.com/cat/says/Hello?filter=invert',
        'https://cataas.com/cat/says/Hello?filter=opacity',
        'https://cataas.com/cat/says/Hello?filter=contrast',
        'https://cataas.com/cat/says/Hello?filter=brightness',
        'https://cataas.com/cat/says/Hello?filter=saturate',
        'https://cataas.com/cat/says/Hello?filter=sepia',
        'https://cataas.com/cat/says/Hello?filter=blur',
        'https://cataas.com/cat/says/Hello?filter=grayscale',
        'https://cataas.com/cat/says/Hello?filter=invert',
    ...
    const options = {
      ...
      borderWidth: `${Math.floor(Math.random() * 10)}px ${Math.floor(
        Math.random() * 10,
      ...
      boxShadow: `${Math.floor(Math.random() * 10)}px ${Math.floor(
        Math.random() * 10,
      )}px ${Math.floor(Math.random() * 10)}px ${Math.floor(
        Math.random() * 10,
      )}px #${Math.floor(Math.random() * 16777215).toString(16)}`,
      textTransform: randomStyle('textTransform'),
      textShadow: `${Math.floor(Math.random() * 10)}px ${Math.floor(
        Math.random() * 10,
      )}px ${Math.floor(Math.random() * 10)}px #${Math.floor(
      ...
      backgroundSize: `${Math.floor(Math.random() * 100)}px ${Math.floor(
        Math.random() * 100,
      )}px`,
      backgroundPosition: `${Math.floor(Math.random() * 100)}px ${Math.floor(
        Math.random() * 100,
      )}px`,
